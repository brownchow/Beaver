...
// TestStatsGetTotalNodes test cases
func TestStatsGetTotalNodes(t *testing.T) {
...
// TestStatsGetTotalChannels test cases
func TestStatsGetTotalChannels(t *testing.T) {
...
// TestStatsGetTotalClients test cases
func TestStatsGetTotalClients(t *testing.T) {
